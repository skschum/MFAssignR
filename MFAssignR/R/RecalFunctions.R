...
Recal <- function(df, peaks, isopeaks = "none",mode, SN = 0, mzRange = 30, series1=NA, series2=NA, series3=NA, series4=NA, series5=NA,
                  series6=NA, series7=NA, series8=NA, series9=NA, series10=NA, step_O = 3, step_H2 = 5){
...
peaks$Range <- 1
#peaks <- dplyr::distinct(peaks, mass, .keep_all = TRUE)  ##New step 12/5/19
...
if(nrow(check) != nrow(check2)) stop("Error: Increase the value of mzRange")

...
MFAssignAll <- function(peaks, isopeaks = "None", ionMode, lowMW=100,highMW=1000, POEx = 0, Nx=0,Sx=0, Px=0, S34x=0,
  ...
  isopeaks2 <- if(isopeaks != "None") isopeaks else data.frame(x=0,y=0)# ,isopeaks = data.frame(x=0, y=0), isopeaks = data.frame(isopeaks))
  ...
  Ambigout <- Ambigout[c(3:27,1,28:32, 2, 33:42)]
  Unambigout <- Unambig2[-c(3,44:49)]
  Unambigout <- Unambigout[c(3:27,1,28:32, 2, 33:42)]

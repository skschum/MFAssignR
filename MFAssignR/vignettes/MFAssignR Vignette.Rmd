...
* Fl - the number of assigned 19F atoms.
...
* NOE - indicates whether the assigned formula is a negative odd electron mass (1) or not (0).
...
* Flx - sets the maximum number of 19F atoms.

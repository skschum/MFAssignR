...
FTable <- data.frame(Features = c("Heteroatoms", "Odd Electron and Sodium Adduct Assignment", "CH2 KMD Pre-Filtering", "DeNovo cut", "Simple Formula Extension", "Advanced Formula Extension", "Standard QA Parameters", "Advanced QA Parameters", "Increased Unambiguity", "Full Ambiguity", "Isotope Matching", "Automatic .rs.Restart()", "Compatible with Rmarkdown", "Improved Performance for MS/MS Data"), MFAssign = c("X", "X", "X", "X", " ", "X", "X", "X", "X", " ", "X", "X", " ", " "), MFAssignCHO = c(" ", "X", "X", "X", " ", "X", "X", "X", "X", " ", "X", "X", " ", " "), MFAssignAll = c("X", "X", "X", " ", "X", " " , "X", "X", " ", "X", "X", "X", " ", " "), MFAssignAll_MSMS = c("X", "X", " ", " ", "X", " " , "X", "X", " ", "X", "X", "X", " ", "X"), MFAssign_RMD = c("X", "X", "X", "X", " ", "X", "X", "X", "X", " ", "X", " ", "X", " "), MFAssignCHO_RMD = c(" ", "X", "X", "X", " ", "X", "X", "X", "X", " ", "X", " ", "X", " "))

FTable %>% 
  kable(format = "html", escape = F, align = c("l", "c", "c", "c", "c", "c", "c")) %>%
  kable_styling(full_width = F) %>%
 column_spec(1, bold = T, border_right = T, width = "30em") %>%
  column_spec(7,  background = "whitesmoke")%>%
  column_spec(6,  background = "whitesmoke")
